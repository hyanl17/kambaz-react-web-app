  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        ...
        tags for different sizes: h1, h2, h3, h4, h5, and h6. Tag h1 
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-1"> 
          ...
          with vertical spaces to make the text easier to read. Browsers 
          ignore vertical white spaces and render all the text as one 
          single set of sentences. To force the browser to add vertical 
          spacing, wrap the paragraphs you want to separate with the 
          paragraph tag
        </p>
        ...
        <p id="wd-p-3">
          This is the second paragraph. Even though we added a deliberate 
