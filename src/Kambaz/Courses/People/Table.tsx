      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-01</td>
            <td className="wd-total-activity">11:00:14</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">07:55:43</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-login-id">001234564T</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2020-10-02</td>
            <td className="wd-total-activity">13:35:13</td>
          </tr>
        </tbody>
      </Table>
    </div> 
